...
(
  id                    serial PRIMARY KEY                  NOT NULL,
  cabin_image_box_id    integer REFERENCES core.image_boxes NULL, -- список картинок, входящих в набор
  front_image_box_id    integer REFERENCES core.image_boxes NULL,
  left_image_box_id     integer REFERENCES core.image_boxes NULL,
  right_image_box_id    integer REFERENCES core.image_boxes NULL,
  back_image_box_id     integer REFERENCES core.image_boxes NULL,
  odometer_image_box_id integer REFERENCES core.image_boxes NULL,
  other_image_box_id    integer REFERENCES core.image_boxes NULL
);
...
CREATE TABLE IF NOT EXISTS core.maintenance_use_items
(
