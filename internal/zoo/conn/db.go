...
func (c *DBPGConfig) validate() error {
    if c.MaxLifetime == 0 {
...
func ConnectDBPostgres(ctx context.Context, cfg *DBPGConfig) (*pgxpool.Pool, error) {
...
func ConnectDBPostgresSQL(ctx context.Context, logger pkg.Logger, cfg *DBPGConfig) (*sql.DB, error) {
